Public Class frmViewScreen
    ...
    Private Sub PictureBox2_Resize(sender As Object, e As EventArgs) Handles PictureBox2.Resize
        ...
        Me.Height = PictureBox2.Height
    End Sub

    Private Sub cmbPrevScreen_Click(sender As Object, e As EventArgs) Handles cmbPrevScreen.Click
        prPrevScreen()
    End Sub

    Private Sub cmbNextScreen_Click(sender As Object, e As EventArgs) Handles cmbNextScreen.Click
        prNextScreen()
    End Sub
